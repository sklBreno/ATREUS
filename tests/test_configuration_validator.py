...
@pytest.mark.parametrize(
    ...
    (
        ...
        ("conversation_history_max_exchanges", 0),
        ("conversation_history_max_exchanges", True),
        ("conversation_history_max_characters", -1),
        ("conversation_history_max_characters", True),
        ("ai_enabled", "true"),
